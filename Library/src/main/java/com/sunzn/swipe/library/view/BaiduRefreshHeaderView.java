...
public class BaiduRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    protected void onFinishInflate() {
        ...
        iv_back_cloud = findViewById(R.id.iv_back_cloud);
        iv_back_cloud2 = findViewById(R.id.iv_back_cloud2);
        iv_back_castle = findViewById(R.id.iv_back_castle);
        iv_back_castle2 = findViewById(R.id.iv_back_castle2);
