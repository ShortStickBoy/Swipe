...
public class CookRefreshHeaderView extends SwipeRefreshHeaderLayout {
    ...
    public CookRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mHeaderHeight = getResources().getDimensionPixelOffset(R.dimen.refresh_header_height_90);
    }
    ...
    protected void onFinishInflate() {
        ...
        ivTest02 = findViewById(R.id.ivTest02);
        ivTest03 = findViewById(R.id.ivTest03);
        ivTest04 = findViewById(R.id.ivTest04);
        iv_pan_cover = findViewById(R.id.iv_pan_cover);
        iv_pan = findViewById(R.id.iv_pan);
    }
